...
public class LivroService {
    ...
    public Page<Livro> pesquisa(String isbn,
                               String titulo, String nomeAutor, GeneroLivro genero, Integer anoPublicacao, Integer pagina, Integer tamanhoPagina){
        Specification<Livro> specs = Specification.where((root, cq, cb) -> cb.conjunction());
        if(isbn != null){
        ...
        if(nomeAutor != null){
            specs = specs.and(LivroSpecs.autorLike(nomeAutor));
        }
