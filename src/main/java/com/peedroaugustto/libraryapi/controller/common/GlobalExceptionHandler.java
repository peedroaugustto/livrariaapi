package com.peedroaugustto.libraryapi.controller.common;

import com.peedroaugustto.libraryapi.controller.dto.ErroCampo;
...
public class GlobalExceptionHandler {
    ...
    public ErroResposta handleMethodArgumentNotValidException(MethodArgumentNotValidException e){
        ...
        List<ErroCampo> listaErros = fieldErrors.stream()
                .map(it -> new ErroCampo(it.getField(), it.getDefaultMessage()))
                .collect(Collectors.toList());
        return new ErroResposta (HttpStatus.UNPROCESSABLE_ENTITY.value(), "Erro de validaçao.", listaErros);
    }
    ...
    public ErroResposta handleErrosNaoTratados(RuntimeException e){
        ...
        return new ErroResposta(
                ...
                "Ocorreu um erro inesperado, Entre em contato com a administraçao",
                List.of()
        );
